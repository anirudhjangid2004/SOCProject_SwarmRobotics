...
;//! \htmlinclude firstmsg.msg.html

(cl:defclass <firstmsg> (roslisp-msg-protocol:ros-message)
  ((first_name
    :reader first_name
    :initarg :first_name
    :type cl:string
...
(cl:defclass firstmsg (<firstmsg>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <firstmsg>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'firstmsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<firstmsg> is deprecated: use beginner_tutorials-msg:firstmsg instead.")))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <firstmsg>))
...
(cl:defmethod last_name-val ((m <firstmsg>))
...
(cl:defmethod age-val ((m <firstmsg>))
...
(cl:defmethod score-val ((m <firstmsg>))
  ...
  (score m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <firstmsg>) ostream)
  "Serializes a message object of type '<firstmsg>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <firstmsg>) istream)
  "Deserializes a message object of type '<firstmsg>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<firstmsg>)))
  "Returns string type for a message object of type '<firstmsg>"
  "beginner_tutorials/firstmsg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'firstmsg)))
  "Returns string type for a message object of type 'firstmsg"
  "beginner_tutorials/firstmsg")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<firstmsg>)))
  "Returns md5sum for a message object of type '<firstmsg>"
  "f8bfa80ae3c7a93455596d9622ad33a9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'firstmsg)))
  "Returns md5sum for a message object of type 'firstmsg"
  "f8bfa80ae3c7a93455596d9622ad33a9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<firstmsg>)))
  "Returns full string definition for message of type '<firstmsg>"
  (cl:format cl:nil "string first_name~%string last_name~%uint8 age~%uint32 score~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'firstmsg)))
  "Returns full string definition for message of type 'firstmsg"
  (cl:format cl:nil "string first_name~%string last_name~%uint8 age~%uint32 score~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <firstmsg>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <firstmsg>))
