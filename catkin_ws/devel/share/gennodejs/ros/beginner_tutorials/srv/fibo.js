...
class fiboRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type fiboRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type fiboRequest
    let len;
    let data = new fiboRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new fiboRequest(null);
    if (msg.a !== undefined) {
      resolved.a = msg.a;
    }
    else {
...
class fiboResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type fiboResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type fiboResponse
    let len;
    let data = new fiboResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new fiboResponse(null);
    if (msg.b !== undefined) {
      resolved.b = msg.b;
    }
    else {
...
module.exports = {
  ...
  datatype() { return 'beginner_tutorials/fibo'; }
};
